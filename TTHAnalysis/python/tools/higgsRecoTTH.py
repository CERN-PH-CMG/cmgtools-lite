...
class HiggsRecoTTH:
    def __init__(self,label="_Recl",cut_BDT_rTT_score = 0.0, cuts_mW_had = (50.,110.), cuts_mH_vis = (90.,130.), btagCSVveto = 0.8484):
        self.label = label
    ...
    def __call__(self,event):
        ...
        if score>self.cut_BDT_rTT_score:
            ...
            jetsNoTopNoB = [j for i,j in enumerate(jets) if i not in [j1top,j2top,j3top] and j.btagCSV<self.btagCSVveto]
