...
`python postproc.py test_output /eos/cms/store/cmst3/user/emanuele/wmass/TREES_1LEP_80X_V2_nano/QCD_Pt20to30_EMEnriched/treeProducerWMass/tree.root -I CMGTools.DPS13TeV.postprocessing.examples.lepSFProducer lepSF -I CMGTools.DPS13TeV.postprocessing.examples.puWeightProducer puWeight --friend`
