...
float ptCorr(float pt, float eta, float phi, float r9, int run, int isData, ULong64_t eventNumber) {
  ...
  if(!calibratorData && isData ) calibratorData = new ElectronEnergyCalibratorRun2Standalone(false,false,"CMGTools/DPS13TeV/python/postprocessing/data/leptonScale/el/Run2016_legacyrereco");
  if(!calibratorMC && !isData ) calibratorMC = new ElectronEnergyCalibratorRun2Standalone(true,false,"CMGTools/DPS13TeV/python/postprocessing/data/leptonScale/el/Run2016_legacyrereco");
