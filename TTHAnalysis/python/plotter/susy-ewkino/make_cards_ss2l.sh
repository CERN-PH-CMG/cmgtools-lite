...
OPTIONS="${OPTIONS} --od cards/160601/$OUTNAME ";
...
if [[ "$1" == "ss2l" ]]; then
    ...
    python makeShapeCardsSusy.py susy-ewkino/mca-ss2l-mc${SPLITDECAYS}.txt susy-ewkino/susy_ss2l_cuts.txt $FUNCTION_2L $SYSTS $OPT_2L -o ss2l ; 
    echo "Done at $(date)"
fi
