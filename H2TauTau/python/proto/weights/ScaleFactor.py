...
class ScaleFactor(object):
    ...
    def getEfficiency(self, pt, eta, eff_dict):
        ...
        if pt >= ptMax:
            ...
            ptBin = g_eff.GetXaxis().FindFixBin(pt)
...
if __name__ == '__main__':
    sf = ScaleFactor('$CMSSW_BASE/src/CMGTools/H2TauTau/data/Muon_SingleMu_eff.root')
    for pt, eta in [(100., 1.5), (50., 0.2), (17., 0.05), (1000., 2.04)]:
