...
O    = "/afs/cern.ch/user/c/cheidegg/www/heppy/2016-07-04_ewk80X_sync_TTW"

# tree input dir
T    = "/mnt/t3nfs01/data01/shome/cheidegg/o/2016-07-04_sync_TTW/"
...
base = "python mcDump.py --dumpFile .fdump.txt susy-ewkino/3l/mca_ewkino_sync.txt susy-ewkino/3l/cuts_ewkino.txt {FMT} -P {T} --s2v --tree treeProducerSusyMultilepton --mcc susy-ewkino/mcc_triggerdefs.txt --mcc susy-ewkino/3l/mcc_ewkino.txt -F sf/t {JLR} -F sf/t {LCH} --load-macro susy-ewkino/3l/functionsEWK.cc -p {PROC} {CUTS} {SC} &&  sort -n -k1 -k2 -k3 .fdump.txt > {O}/fdump_{PROC}.txt && rm .fdump.txt"
