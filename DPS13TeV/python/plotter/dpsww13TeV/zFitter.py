...
from CMGTools.DPS13TeV.plotter.tree2yield import scalarToVector
...
if "/wmass/functionsWMass_cc.so" not in ROOT.gSystem.GetLibraries(): 
    ROOT.gROOT.ProcessLine(".L %s/src/CMGTools/DPS13TeV/python/plotter/wmass/functionsWMass.cc+" % os.environ['CMSSW_BASE']);
