...
thevars = [
    ...
    'Jet0_pt','Jet0_eta','Jet0_phi','Jet0_mass','Jet0_btagdiscr',#'Jet1_mass',
    'Jet1_pt','Jet1_eta','Jet1_phi','Jet1_mass','Jet1_btagdiscr',#'Jet1_mass',
    'Jet2_pt','Jet2_eta','Jet2_phi','Jet2_mass','Jet2_btagdiscr',#'Jet2_mass',
    'Jet3_pt','Jet3_eta','Jet3_phi','Jet3_mass','Jet3_btagdiscr',#'Jet2_mass',
