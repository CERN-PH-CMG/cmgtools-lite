...
TFile* trigSF = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/triggerSF/EWKino_9p2_triggerSF.root", "read");
TFile* trigSFele27 = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/triggerSF/EWKino_12p9_triggerSF_ele27.root", "read");
...
// electrons
TFile* elSFmva = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_electron_lepMVAmedium.root", "read");
TFile* elSFeff = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_electron_trackingEff.root", "read");
...
// muons
TFile* muSFmva = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_muon_lepMVAmedium.root", "read");
TFile* muSFid  = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_muon_mediumId.root"   , "read");
TFile* muSFeff = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_muon_trackingEff.root", "read"); 
...
// electrons
TFile* elSFmvaFS = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_electron_lepMVAmedium_FS.root", "read");
TFile* elSFidFS  = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_electron_mvaID_FS.root", "read");
TH2F* _lepSF_eMVA_FS = (TH2F*) elSFmvaFS->Get("histo2D");
TH2F* _lepSF_eID_FS  = (TH2F*) elSFidFS ->Get("histo2D");

// muons
TFile* muSFmvaFS = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_muon_lepMVAmedium_FS.root", "read");
TFile* muSFidFS  = new TFile("/mnt/t3nfs01/data01/shome/cheidegg/d/CMSSW_8_0_11/src/CMGTools/TTHAnalysis/data/leptonSF/SF2016_muon_mediumId_FS.root"   , "read");
