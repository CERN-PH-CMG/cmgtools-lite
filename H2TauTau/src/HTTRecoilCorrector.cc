...
HTTRecoilCorrector::HTTRecoilCorrector(TString fileName) {
...
void HTTRecoilCorrector::InitMEtWeights(TFile * _file,
				     TString  _perpZStr,
				     TString  _paralZStr,
				     int nZPtBins,
				     float * ZPtBins,
...
void HTTRecoilCorrector::InitMEtWeights(TFile * _fileMet,
...
void HTTRecoilCorrector::Correct(float MetPx,
			      float MetPy,
			      float genVPx, 
			      float genVPy,
			      float visVPx,
...
void HTTRecoilCorrector::CorrectByMeanResolution(float MetPx,
					      float MetPy,
					      float genVPx, 
					      float genVPy,
					      float visVPx,
...
float HTTRecoilCorrector::CorrectionsBySampling(float x, TF1 * funcMC, TF1 * funcData) {
...
void HTTRecoilCorrector::U1U2CorrectionsByWidth(float & U1, 
					     float & U2,
					     int ZptBin,
					     int njets) {
...
float HTTRecoilCorrector::rescale(float x,
			       float meanData, 
			       float meanMC,
...
void HTTRecoilCorrector::CalculateU1U2FromMet(float metPx,
					   float metPy,
					   float genZPx,
					   float genZPy,
					   float diLepPx,
...
void HTTRecoilCorrector::CalculateMetFromU1U2(float U1,
					   float U2,
					   float genZPx,
					   float genZPy,
					   float diLepPx,
