...
do
python ../prepareEventVariablesFriendTree.py -t NanoAOD -d $i /nfs/user/pvischia/tth/v6/NanoTrees_TTH_091019_v6pre_skim2lss/2017/ $2 -I CMGTools.TTHAnalysis.tools.nanoAOD.ttH_modules higgsRecoTTH -j 4 -F Friends {P}0_jmeUnc_v1/{cname}_Friend.root -F Friends {P}2_scalefactors/{cname}_Friend.root -F Friends {P}3_tauCount/{cname}_Friend.root -F Friends {P}1_recl/{cname}_Friend.root -F Friends {P}5_BDThtt_reco/{cname}_Friend.root --env uclouvain -q cp3
done 
fi
#####################################
...
for i in TBar_tWch_noFullyHad TBar_tch TBar_tch_PS TGJets_lep THQ_ctcvcp THW_ctcvcp TTGJets TTJets_DiLepton TTJets_SingleLeptonFromT TTJets_SingleLeptonFromTbar TTTT TTTT_PS TTWH TTWToLNu_fxfx TTWToLNu_fxfx_PS TTWW TTZH TTZToLLNuNu_amc TTZToLLNuNu_amc_PS TTZToLLNuNu_m1to10 TZQToLL T_sch_lep T_sch_lep_PS T_tWch_noFullyHad T_tch T_tch_PS VHToNonbb VHToNonbb_ll WGToLNuG WJetsToLNu_LO WWTo2L2Nu WWTo2L2Nu_DPS WWTo2L2Nu_PS WWW WWW_ll WWZ WW_DPS WZG WZTo3LNu_fxfx WZZ WpWpJJ ZGTo2LG ZHToTauTau ZHTobb_ll ZZTo4L ZZZ tWll GGHZZ4L DYJetsToLL_M10to50_LO DYJetsToLL_M50 
do
python ../prepareEventVariablesFriendTree.py -t NanoAOD -d $i /nfs/user/pvischia/tth/v6/NanoTrees_TTH_091019_v6pre_skim2lss/2017/ $2 -I CMGTools.TTHAnalysis.tools.nanoAOD.ttH_modules higgsRecoTTHNoTopTagger -j 4 -F Friends {P}0_jmeUnc_v1/{cname}_Friend.root -F Friends {P}2_scalefactors/{cname}_Friend.root -F Friends {P}3_tauCount/{cname}_Friend.root -F Friends {P}1_recl/{cname}_Friend.root -F Friends {P}5_BDThtt_reco/{cname}_Friend.root --env uclouvain -q cp3   
done
fi
#####################################
...
do
python ../prepareEventVariablesFriendTree.py -t NanoAOD -d $i /nfs/user/pvischia/tth/v6/NanoTrees_TTH_091019_v6pre_skim2lss/2018/ $2 -I CMGTools.TTHAnalysis.tools.nanoAOD.ttH_modules higgsRecoTTH -j 4 -F Friends {P}0_jmeUnc_v1/{cname}_Friend.root -F Friends {P}2_scalefactors/{cname}_Friend.root -F Friends {P}3_tauCount/{cname}_Friend.root -F Friends {P}1_recl/{cname}_Friend.root -F Friends {P}5_BDThtt_reco/{cname}_Friend.root --env uclouvain -q cp3
done 
fi
#####################################
...
for i in TBar_tWch_noFullyHad TBar_tch TGJets_lep THQ_ctcvcp THW_ctcvcp TTGJets TTJets_DiLepton TTJets_SingleLeptonFromT TTJets_SingleLeptonFromTbar TTTT TTWH TTWToLNu_fxfx TTWW TTZH TTZToLLNuNu_amc TTZToLLNuNu_m1to10 TZQToLL T_sch_lep T_tWch_noFullyHad T_tch VHToNonbb VHToNonbb_ll WGToLNuG WJetsToLNu_LO WWTo2L2Nu WWTo2L2Nu_DPS WWW WWW_ll WWZ WW_DPS WZG WZTo3LNu_fxfx WZTo3LNu_pow WZZ WpWpJJ ZGTo2LG ZHToTauTau ZHTobb_ll ZZTo4L ZZZ tWll  GGHZZ4L DYJetsToLL_M10to50_LO DYJetsToLL_M50
do
python ../prepareEventVariablesFriendTree.py -t NanoAOD -d $i /nfs/user/pvischia/tth/v6/NanoTrees_TTH_091019_v6pre_skim2lss/2018/ $2 -I CMGTools.TTHAnalysis.tools.nanoAOD.ttH_modules higgsRecoTTHNoTopTagger -j 4 -F Friends {P}0_jmeUnc_v1/{cname}_Friend.root -F Friends {P}2_scalefactors/{cname}_Friend.root -F Friends {P}3_tauCount/{cname}_Friend.root -F Friends {P}1_recl/{cname}_Friend.root -F Friends {P}5_BDThtt_reco/{cname}_Friend.root --env uclouvain -q cp3   
done
fi
#####################################
