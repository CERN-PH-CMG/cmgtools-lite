...
etaRange="0.0,0.3,0.6,0.9,1.2,1.479,1.7,1.9,2.1,2.3,2.5"
#etaRange="0.0,1.479,2.5"
...
testdir="SRtrees_new/fakeRate_${mtDefinition}_${ptDefinition}_pfmet20_HLT27_tightChargeNum_5binEB_5binEE_FRskimV6"
