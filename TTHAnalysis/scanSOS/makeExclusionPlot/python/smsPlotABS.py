...
class smsPlotABS(object):
    ...
    def DrawText(self):
        ...
        if(self.model.label2 == ""):
            graphWhite.SetPoint(2,self.model.Xmax, self.model.Ymax*0.78)
            graphWhite.SetPoint(3,self.model.Xmin, self.model.Ymax*0.78)
        else:
    ...
    def DrawLegend(self):
        ...
        textExp = rt.TLatex(self.model.Xmin+11*xRange/100, self.model.Ymax-2.15*yRange/100*10+offset, 
                      #      "Expected #pm 1 #sigma_{experiment}")#for ChiNeu
                            "Expected  #pm 1 #sigma_{experiment} #pm 2 #sigma_{experiment}")
