...
O      = "/afs/cern.ch/user/c/cheidegg/www/heppy/2016-06-21_ewk80X_effs"
...
for c,v in effs.iteritems():
	...
	for p in procs:
		cmd(baseAll.format(O=output+"/"+c+"_"+b+"_"+p[0]+".txt", T=T, L=lumi, JLR="{P}/"+jlr+"/evVarFriend_{cname}.root", LCH="{P}/"+lch+"/evVarFriend_{cname}.root", CUTS=cuts, PROC="-p " + p[1], FLAGS=flags))
