...
ODIR="~/www/data13fb_validation_jul20"
MYTREEDIR="/data1/peruzzi/mixture_jecv6prompt_datafull_jul20"
MYLUMI="12.9"

EXE="python mcPlots.py"
WDIR="lepton-validation"
COMMOPT='--s2v --tree treeProducerSusyMultilepton --rspam "%(lumi) (13 TeV)  " --lspam "#bf{CMS} #it{Internal}" --legendBorder=0 --legendFontSize 0.055 --legendWidth=0.30  -j 8 -f --sp ".*" --showMCError --showRatio --maxRatioRange 0 2 -W "puw2016_vtx_13fb(nVert)" -A filters sip8 "LepGood_sip3d[iChosen]<8" --mcc ttH-multilepton/mcc-ichepMediumMuonId.txt '+(' '.join(sys.argv[1:]))

#SELECTIONS=["ZtoEE","ZtoMuMu","ttbar","Wl","Zl","ttbar_semiLeptonic"]
SELECTIONS=["ZtoMuMu","Zl","ttbar_semiLeptonic"]
