...
TString DATA = CMSSW_BASE_EWK+"/src/CMGTools/TTHAnalysis/data";
...
TFile* f_trigSF       = new TFile(DATA+"/triggerSF/triggerSF_EWKino_fullsim_ICHEP2016_9p2fb.root"       , "read");
TFile* f_trigSF_ele27 = new TFile(DATA+"/triggerSF/triggerSF_Ele27_EWKino_fullsim_ICHEP2016_12p9fb.root", "read");
...
// electrons
TFile* f_elSF_id   = new TFile(DATA+"/leptonSF/electronSF_id_EWKino_fullsim_ICHEP2016_12p9fb.root"    , "read");
TFile* f_elSF_eff  = new TFile(DATA+"/leptonSF/electronSF_trkEff_EWKino_fullsim_ICHEP2016_12p9fb.root", "read");
...
// muons
TFile* f_muSF_mvaVT = new TFile(DATA+"/leptonSF/muonSF_mvaVT_EWKino_fullsim_ICHEP2016_12p9fb.root", "read");
TFile* f_muSF_mvaM  = new TFile(DATA+"/leptonSF/muonSF_mvaM_EWKino_fullsim_ICHEP2016_12p9fb.root" , "read");
TFile* f_muSF_id    = new TFile(DATA+"/leptonSF/muonSF_id_EWKino_fullsim_ICHEP2016_12p9fb.root"   , "read");
TFile* f_muSF_eff   = new TFile(DATA+"/leptonSF/muonSF_trk_EWKino_fullsim_ICHEP2016_12p9fb.root"  , "read"); 
...
// electrons
TFile* f_elSF_FS_mvaM = new TFile(DATA+"/leptonSF/electronSF_mvaVT_EWKino_fastsim_ICHEP2016_12p9fb.root", "read");
TFile* f_elSF_FS_mvaM = new TFile(DATA+"/leptonSF/electronSF_mvaM_EWKino_fastsim_ICHEP2016_12p9fb.root" , "read");
TFile* f_elSF_FS_id   = new TFile(DATA+"/leptonSF/electronSF_id_EWKino_fastsim_ICHEP2016_12p9fb.root"   , "read");
...
// muons
TFile* f_muSF_FS_mvaVT = new TFile(DATA+"/leptonSF/muonSF_mvaVT_EWKino_fastsim_ICHEP2016_12p9fb.root", "read");
TFile* f_muSF_FS_mvaM  = new TFile(DATA+"/leptonSF/muonSF_mvaM_EWKino_fastsim_ICHEP2016_12p9fb.root" , "read");
TFile* f_muSF_FS_id    = new TFile(DATA+"/leptonSF/muonSF_id_EWKino_fastsim_ICHEP2016_12p9fb.root"   , "read");
...
// taus
TFile* f_tauSF_FS_id = new TFile(DATA+"/leptonSF/tauSF_id_EWKino_fastsim_ICHEP2016_12p9fb.root", "read");
