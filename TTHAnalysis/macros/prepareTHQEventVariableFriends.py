...
from prepareEventVariablesFriendTree import VariableProducer

###########################################################
## This should all be imported rather than copied.
## But that would require a rewrite of the original.
##
## Test this on a single chunk:
