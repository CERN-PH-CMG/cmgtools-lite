...
O    = "/afs/cern.ch/user/c/cheidegg/www/heppy/2016-06-26_ewk80X_limits"
...
base = "python makeShapeCardsSusy.py susy-ewkino/4l/mca_ewkino.txt susy-ewkino/4l/cuts_ewkino.txt \"{EXPR}\" \"{BINS}\" susy-ewkino/{SYSTS} -o SR -P {T} --mcc susy-ewkino/mcc_triggerdefs.txt --mcc susy-ewkino/4l/mcc_ewkino.txt --neg --s2v --tree treeProducerSusyMultilepton -F sf/t {JLR} -F sf/t {LCH} -f -j 8 --od {O} -l {L} {BKG} {SIG} {CUTS} {FLAGS} --load-macro susy-ewkino/4l/functionsEWK.cc"
