...
hzz_globalVariables = [
    ...
    NTupleVariable("genDPhiZZ", lambda ev: ev.genDPhiZZ, mcOnly=True, help="deltaPhi(ZZ) at gen level"),
    NTupleVariable("genDPhiZZWeight", lambda ev: ev.genDPhiZZWeight, mcOnly=True, help="deltaPhi(ZZ) at gen level"),
    NTupleVariable("genDPhiZZSameFlavour", lambda ev: ev.genDPhiZZSameFlavour, int, mcOnly=True, help="deltaPhi(ZZ) at gen level"),
]
