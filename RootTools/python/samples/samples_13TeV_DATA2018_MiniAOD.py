...
EGamma_Run2018D_PromptReco_v2 = kreator.makeDataComponent("EGamma_Run2018D_PromptReco_v2", "/EGamma/Run2018D-PromptReco-v2/MINIAOD", "CMS", ".*root", json)
SingleMuon_Run2018D_PromptReco_v2 = kreator.makeDataComponent("SingleMuon_Run2018D_PromptReco_v2", "/SingleMuon/Run2018D-PromptReco-v2/MINIAOD", "CMS", ".*root", json)
