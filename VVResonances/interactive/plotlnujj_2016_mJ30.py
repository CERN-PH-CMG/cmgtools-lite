...
total_weight = '(nlnujj>0)*(lnujj_l2_softDrop_massBare*lnujj_l2_softDrop_massCorr>30.)'
...
samples_mc, samples_data, samples, all_samples, sampleDict = createSampleLists(analysis_dir, channel='WV', weight=weight_MC, vJetsKFac=0.88)
