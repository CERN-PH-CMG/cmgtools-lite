...
from CMGTools.RootTools.samples.samples_13TeV_RunIIFall15MiniAODv2 import DY1JetsToLL_M50_LO, DY2JetsToLL_M50_LO, DY3JetsToLL_M50_LO, DY4JetsToLL_M50_LO, DYJetsToLL_M10to50_ext, DYJetsToLL_M50_LO_ext
...
DYJetsToLL_M50_LO_ext.nevents = [1000.]
...
for sample in [DYJetsToLL_M50_LO, DYJetsToLL_M50_LO_ext] + DYNJets + [DYJetsToTauTau_M150_LO]:
...
backgrounds += DYNJets
backgrounds += [DYJetsToTauTau_M150_LO, DYJetsToLL_M10to50_ext, DYJetsToLL_M50_LO_ext]
backgrounds += WNJets
