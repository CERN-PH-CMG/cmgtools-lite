#!/usr/bin/env python
# USAGE: python systRatios.py  cards/XXX/ el -s 'CMS_We_FRe_pt' -o plots/
import ROOT, os, copy
...
if __name__ == "__main__":
    ...
    parser.add_option('-s','--syst', dest='systematics', default=None, type='string', help='systematics of which drawing the ratio (comma-separated list of systematics')
