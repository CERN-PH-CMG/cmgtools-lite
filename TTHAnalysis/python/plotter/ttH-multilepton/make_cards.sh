...
if [[ "$1" == "all" || "$1" == "2lss" ]]; then
	...
	if [[ "${X}" == "ee" ]]; then
	    ...
	    python makeShapeCards.py ${DOFILE} --2d-binning-function 6:ttH_MVAto1D_6_2lss_Marco ttH-multilepton/mca-2lss-mcdata-frdata.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_0tau_bl_pos $POS $BLoose $FLAV $ZeroTau;
            python makeShapeCards.py ${DOFILE} --2d-binning-function 6:ttH_MVAto1D_6_2lss_Marco ttH-multilepton/mca-2lss-mcdata-frdata.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_0tau_bl_neg $NEG $BLoose $FLAV $ZeroTau;
            python makeShapeCards.py ${DOFILE} --2d-binning-function 6:ttH_MVAto1D_6_2lss_Marco ttH-multilepton/mca-2lss-mcdata-frdata.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_0tau_bt_pos $POS $BTight $FLAV $ZeroTau;
            python makeShapeCards.py ${DOFILE} --2d-binning-function 6:ttH_MVAto1D_6_2lss_Marco ttH-multilepton/mca-2lss-mcdata-frdata.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_0tau_bt_neg $NEG $BTight $FLAV $ZeroTau;
	fi
    done

    python makeShapeCards.py ${DOFILE} --2d-binning-function 6:ttH_MVAto1D_6_2lss_Marco ttH-multilepton/mca-2lss-mcdata-frdata.txt ttH-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_1tau $OneTau;
...
if [[ "$1" == "all" || "$1" == "3l" ]]; then
    ...
    echo "3l";
    python makeShapeCards.py ${DOFILE} --2d-binning-function 3:ttH_MVAto1D_3_3l_Marco ttH-multilepton/mca-3l-mcdata-frdata.txt ttH-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bl_pos $POS $BLoose;
    python makeShapeCards.py ${DOFILE} --2d-binning-function 3:ttH_MVAto1D_3_3l_Marco ttH-multilepton/mca-3l-mcdata-frdata.txt ttH-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bl_neg $NEG $BLoose;
    python makeShapeCards.py ${DOFILE} --2d-binning-function 3:ttH_MVAto1D_3_3l_Marco ttH-multilepton/mca-3l-mcdata-frdata.txt ttH-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bt_pos $POS $BTight;
    python makeShapeCards.py ${DOFILE} --2d-binning-function 3:ttH_MVAto1D_3_3l_Marco ttH-multilepton/mca-3l-mcdata-frdata.txt ttH-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bt_neg $NEG $BTight;
