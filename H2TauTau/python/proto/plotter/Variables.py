...
additional_tau_vars = [
    ...
    VCfg(name='tau_chargedIsoPtSum', binning={'nbinsx':50, 'xmin':0., 'xmax':50.}, unit='', xtitle='charged isolation (GeV)'),
    VCfg(name='tau_neutralIsoPtSum', binning={'nbinsx':50, 'xmin':0., 'xmax':50.}, unit='', xtitle='neutral isolation (GeV)'),
    VCfg(name='tau_photonPtSumOutsideSignalCone', binning={'nbinsx':50, 'xmin':0., 'xmax':30.}, unit='', xtitle='tau photon p_{T} outer (GeV)'),
    VCfg(name='tau_iso_n_ch', binning={'nbinsx':41, 'xmin':-0.5, 'xmax':40.5}, unit='', xtitle='tau isolation N_{charged hadrons}'),
    VCfg(name='tau_iso_n_gamma', binning={'nbinsx':41, 'xmin':-0.5, 'xmax':40.5}, unit='', xtitle='tau isolation N_{photons}'),
    VCfg(name='tau_lead_ch_pt', drawname='log(abs(tau_lead_ch_pt)) - 999*(tau_lead_ch_pt<0)', binning={'nbinsx':40, 'xmin':-0.1, 'xmax':6.}, unit='GeV', xtitle='log(tau iso leading CH p_{T})'),
    VCfg(name='tau_lead_ch_dxy', drawname='log(abs(tau_lead_ch_dxy))', binning={'nbinsx':40, 'xmin':-12., 'xmax':-2.}, unit='cm', xtitle='log(tau iso leading CH d_{xy})'),
    VCfg(name='tau_lead_ch_dz', drawname='log(abs(tau_lead_ch_dz))', binning={'nbinsx':40, 'xmin':-12., 'xmax':3.}, unit='cm', xtitle='log(tau iso leading CH d_{z})'),
    VCfg(name='tau_lead_ch_ndof', binning={'nbinsx':34, 'xmin':-0.5, 'xmax':33.5}, unit='', xtitle='tau iso leading CH ndof'),
    VCfg(name='tau_lead_ch_normchi2', binning={'nbinsx':100, 'xmin':-0., 'xmax':49.5}, unit='', xtitle='tau iso leading CH normalized chi2'),
    VCfg(name='tau_lead_ch_chi2', binning={'nbinsx':100, 'xmin':-0., 'xmax':49.5}, unit='', xtitle='tau iso leading CH  chi2'),
    VCfg(name='tau_lead_ch_n_layers_pixel', binning={'nbinsx':6, 'xmin':-0.5, 'xmax':5.5}, unit='', xtitle='tau iso leading CH N_{pixel layers}'),
    VCfg(name='tau_lead_ch_n_hits_pixel', binning={'nbinsx':9, 'xmin':-0.5, 'xmax':8.5}, unit='', xtitle='tau iso leading CH N_{pixel hits}'),
    VCfg(name='tau_lead_ch_n_layers_tracker', binning={'nbinsx':6, 'xmin':-0.5, 'xmax':5.5}, unit='', xtitle='tau iso leading CH N_{tracker layers}'),
    VCfg(name='tau_lead_ch_n_hits', binning={'nbinsx':32, 'xmin':-0.5, 'xmax':31.5}, unit='', xtitle='tau iso leading CH N_{hits}'),
    VCfg(name='tau_lead_ch_n_missing_inner', binning={'nbinsx':4, 'xmin':-0.5, 'xmax':3.5}, unit='', xtitle='tau iso leading CH N_{missing inner hits}'),

    VCfg(name='tau_leadiso_ch_pt', drawname='log(abs(tau_leadiso_ch_pt)) - 999*(tau_leadiso_ch_pt<0)', binning={'nbinsx':40, 'xmin':-0.1, 'xmax':6.}, unit='GeV', xtitle='log(tau iso leading CH p_{T})'),
    VCfg(name='tau_leadiso_ch_dxy', drawname='log(abs(tau_leadiso_ch_dxy))', binning={'nbinsx':40, 'xmin':-12., 'xmax':-2.}, unit='cm', xtitle='log(tau iso leading CH d_{xy})'),
    VCfg(name='tau_leadiso_ch_dz', drawname='log(abs(tau_leadiso_ch_dz))', binning={'nbinsx':40, 'xmin':-12., 'xmax':3.}, unit='cm', xtitle='log(tau iso leading CH d_{z})'),
    VCfg(name='tau_leadiso_ch_ndof', binning={'nbinsx':34, 'xmin':-0.5, 'xmax':33.5}, unit='', xtitle='tau iso leading CH ndof'),
    VCfg(name='tau_leadiso_ch_normchi2', binning={'nbinsx':100, 'xmin':-0., 'xmax':49.5}, unit='', xtitle='tau iso leading CH normalized chi2'),
    VCfg(name='tau_leadiso_ch_chi2', binning={'nbinsx':100, 'xmin':-0., 'xmax':49.5}, unit='', xtitle='tau iso leading CH  chi2'),
    VCfg(name='tau_leadiso_ch_n_layers_pixel', binning={'nbinsx':6, 'xmin':-0.5, 'xmax':5.5}, unit='', xtitle='tau iso leading CH N_{pixel layers}'),
    VCfg(name='tau_leadiso_ch_n_hits_pixel', binning={'nbinsx':9, 'xmin':-0.5, 'xmax':8.5}, unit='', xtitle='tau iso leading CH N_{pixel hits}'),
    VCfg(name='tau_leadiso_ch_n_layers_tracker', binning={'nbinsx':6, 'xmin':-0.5, 'xmax':5.5}, unit='', xtitle='tau iso leading CH N_{tracker layers}'),
    VCfg(name='tau_leadiso_ch_n_hits', binning={'nbinsx':32, 'xmin':-0.5, 'xmax':31.5}, unit='', xtitle='tau iso leading CH N_{hits}'),
    VCfg(name='tau_leadiso_ch_n_missing_inner', binning={'nbinsx':4, 'xmin':-0.5, 'xmax':3.5}, unit='', xtitle='tau iso leading CH N_{missing inner hits}'),
