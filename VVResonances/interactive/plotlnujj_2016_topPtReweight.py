...
samples_mc, samples_data, samples, all_samples, sampleDict = createSampleLists(analysis_dir, channel='WV', weight=weight_MC, reweightTop=False)
...
for cut_name in cuts:
    ...
    for variable in variables:
        ...
        HistDrawer.draw(plot, plot_dir='plots_lnujj_NoTopPtReweight/'+cut_name, channel=channel)
