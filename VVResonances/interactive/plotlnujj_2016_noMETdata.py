...
for cut_name in cuts:
    ...
    for variable in variables:
        ...
        plot.Group('Top', ['TT_pow_W', 'TT_pow_nonW', 'Ttch_powheg', 'TBar_tch_powheg', 'TToLeptons_sch', 'TBar_tWch', 'T_tWch'])
        ...
        HistDrawer.draw(plot, plot_dir='plots_lnujj_noMETdata/'+cut_name, channel=channel)
