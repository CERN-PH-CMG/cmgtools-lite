...
TH1F *delR_q1_l = new TH1F("delR_q1_l","delR_q1_l", 25, 0, 5);
...
//TFile *f  = new TFile("./TTHnobb_fxfx_Friend.root");
TTree *tr = (TTree*)f->Get("Friends");
TH1F *delR_q2_l = new TH1F("delR_q2_l","delR_q2_l", 25, 0, 5);
...
//TFile *f  = new TFile("./TTHnobb_fxfx_Friend.root");
TTree *tr = (TTree*)f->Get("Friends");
TH1F *delR_partons = new TH1F("delR_partons","delR_partons", 25, 0, 5);
...
//TFile *f  = new TFile("./TTHnobb_fxfx_Friend.root");
TTree *tr = (TTree*)f->Get("Friends");
TH1F *delR_j1j2 = new TH1F("delR_j1j2","delR_j1j2", 25, 0, 5);
tr->Draw("Hreco_delR_H_j1j2>>delR_j1j2","Hreco_delR_H_j1j2>=0 && Hreco_matchedpartons ==1");
TH1F *delR_j1j2_2 = new TH1F("delR_j1j2_2","delR_j1j2_2", 25, 0, 5);
...
//TFile *f  = new TFile("./TTHnobb_fxfx_Friend.root");
TTree *tr = (TTree*)f->Get("Friends");
TH1F *delR_j1l = new TH1F("delR_j1l","delR_j1l", 25, 0, 5);
...
//TFile *f  = new TFile("./TTHnobb_fxfx_Friend.root");
TTree *tr = (TTree*)f->Get("Friends");
TH1F *delR_j2l = new TH1F("delR_j2l","delR_j2l", 25, 0, 5);
