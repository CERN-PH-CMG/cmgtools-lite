...
CandidateBoostedDoubleSecondaryVertexComputerLight::CandidateBoostedDoubleSecondaryVertexComputerLight(
  ...
  trackPairV0Filter(), trackSelector()
{
  uses(0, "ipTagInfos");
  uses(1, "svTagInfos");
  ...
  trackPairV0Filter = reco::V0Filter(trackPairV0FilterPSet);
  ...
  trackSelector = reco::TrackSelector(trackSelectionPSet);
...
float CandidateBoostedDoubleSecondaryVertexComputerLight::discriminator(const TagInfoHelper & tagInfo) const
{
  // get TagInfos
