...
INDIR="/pool/ciencias/HeppyTrees/RA7/estructura/trees_8011_July5_allscans/"


if [ "$1" == "generalplots" ]; then
    ...
    python susy-interface/plotmaker.py 3l 3lA ${INDIR}  ~/www/susyRA7/ -l 12.9 --make data --plots br -o SR --pretend
    ...
    # I:         3lI         SR-96            3l + 1tau
    python susy-interface/plotmaker.py 3l 3lA
