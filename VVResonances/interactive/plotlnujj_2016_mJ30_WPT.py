...
cuts['lnujj_ttbar_mu_LP_b'] = findCut(categories, cat="lnujj", lep="mu", tau21="LP", reg="b")
cuts['lnujj_ttbar_e_LP_b'] = findCut(categories, cat="lnujj", lep="e", tau21="LP", reg="b")
...
cuts['lnujj_mu_SP_veto_mV_nob'] = findCut(categories, cat="lnujj", lep="mu", tau21="SP", mJ="VetoV", reg="nob")
cuts['lnujj_e_SP_veto_mV_nob'] = findCut(categories, cat="lnujj", lep="e", tau21="SP", mJ="VetoV", reg="nob")
cuts['lnujj_e_LP_veto_mV_nob'] = findCut(categories, cat="lnujj", lep="e", tau21="LP", mJ="VetoV", reg="nob")
cuts['lnujj_mu_LP_veto_mV_nob'] = findCut(categories, cat="lnujj", lep="mu", tau21="LP", mJ="VetoV", reg="nob")
...
for cut_name in cuts:
    ...
    for variable in variables:
        ...
        plot.Group('Top', ['TT_pow_W', 'TT_pow_nonW', 'T_tch_powheg', 'TBar_tch_powheg', 'TToLeptons_sch', 'TBar_tWch', 'T_tWch'])
        plot.Group('VJets', ["WJetsToLNu_Pt_100To250", "WJetsToLNu_Pt_250To400", "WJetsToLNu_Pt_400To600", "WJetsToLNu_Pt_600ToInf", 'DYJetsToLL_M50_HT100to200', 'DYJetsToLL_M50_HT200to400', 'DYJetsToLL_M50_HT400to600', 'DYJetsToLL_M50_HT600to800', 'DYJetsToLL_M50_HT800to1200', 'DYJetsToLL_M50_HT1200to2500', 'DYJetsToLL_M50_HT2500toInf'])
        ...
        HistDrawer.draw(plot, plot_dir='plots_lnujj_mJ30_WPT/'+cut_name, channel=channel)
