...
TTs = [TTJets, TT_pow, TT_pow_ext3,TT_pow_herwig,TT_pow_herwig_ext2,TT_pow_herwig_ext3]
background = TTs+SingleTop+DYJetsM50HT+WJetsToLNuHT+QCDHT+DiBosons

TTHerwig = [TT_pow_herwig,TT_pow_herwig_ext2,TT_pow_herwig_ext3]
...
SinglePhoton = [SinglePhoton_Run2016B_03Feb2017_v2, SinglePhoton_Run2016C_03Feb2017, SinglePhoton_Run2016D_03Feb2017, SinglePhoton_Run2016E_03Feb2017, SinglePhoton_Run2016F_03Feb2017, SinglePhoton_Run2016G_03Feb2017, SinglePhoton_Run2016H_03Feb2017_v2, SinglePhoton_Run2016H_03Feb2017_v3]
...
for s in SingleElectron:
    s.triggers = triggers_1e+triggers_1e_noniso
    s.vetoTriggers = triggers_1mu_noniso+triggers_1mu_iso

for s in SinglePhoton:
    s.triggers = triggers_photon175
    s.vetoTriggers = triggers_1mu_noniso+triggers_1mu_iso+triggers_1e+triggers_1e_noniso
 

# MET to be used for jj +MET but also to recover trigger efficiency for leptons
for s in MET:
    s.triggers = triggers_metNoMu120_mhtNoMu120
    s.vetoTriggers = triggers_1mu_noniso+triggers_1mu_iso+triggers_1e+triggers_1e_noniso+triggers_photon175
...
dataSamplesLNUJ = SingleMuon+SingleElectron+SinglePhoton+MET
